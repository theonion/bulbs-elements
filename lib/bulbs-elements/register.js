    ...
    attachedCallback () {
      ...
      function elementQuery (element) {
        ...
        function elementQueryLoop () {
          ...
          if (lastWidth !== element.offsetWidth) {
            if (element.offsetWidth < 450) {
              element.setAttribute('data-breakpoint', 'sm');
            }
            else if (element.offsetWidth < 600) {
              element.setAttribute('data-breakpoint', 'md');
            }
            else if (element.offsetWidth < 768) {
              element.setAttribute('data-breakpoint', 'lg');
            }
            else if (element.offsetWidth < 1000) {
              element.setAttribute('data-breakpoint', 'xlg');
            }

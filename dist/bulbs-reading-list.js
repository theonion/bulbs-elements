...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./bulbs-reading-list.scss */ 250);
	
	__webpack_require__(/*! ./components/bulbs-reading-list-item */ 252);
	
	__webpack_require__(/*! ./components/bulbs-reading-list-articles */ 253);
	
	__webpack_require__(/*! ./components/bulbs-reading-list-menu */ 254);
	
	var _readingListEventManager = __webpack_require__(/*! ./lib/reading-list-event-manager */ 255);
	
	var _readingListEventManager2 = _interopRequireDefault(_readingListEventManager);
	...
	var BulbsReadingList = function (_BulbsHTMLElement) {
	  ...
	  BulbsReadingList.prototype.attachedCallback = function attachedCallback() {
	    var eventManager = new _readingListEventManager2.default(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _copyAttribute = __webpack_require__(/*! ./copy-attribute */ 191);
	
	var _copyAttribute2 = _interopRequireDefault(_copyAttribute);
	
	var _filterBadResponse = __webpack_require__(/*! ./filter-bad-response */ 192);
	
	var _filterBadResponse2 = _interopRequireDefault(_filterBadResponse);
	
	var _getResponseJson = __webpack_require__(/*! ./get-response-json */ 193);
	
	var _getResponseJson2 = _interopRequireDefault(_getResponseJson);
	
	var _iterateObject = __webpack_require__(/*! ./iterate-object */ 195);
	
	var _iterateObject2 = _interopRequireDefault(_iterateObject);
	
	var _loadOnDemand = __webpack_require__(/*! ./load-on-demand */ 196);
	
	var _loadOnDemand2 = _interopRequireDefault(_loadOnDemand);
	
	var _makeRequest = __webpack_require__(/*! ./make-request */ 197);
	
	var _makeRequest2 = _interopRequireDefault(_makeRequest);
	
	var _moveChildren = __webpack_require__(/*! ./move-children */ 199);
	
	var _moveChildren2 = _interopRequireDefault(_moveChildren);
	
	var _supportsCalcInTransform = __webpack_require__(/*! ./supports-calc-in-transform */ 200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _react = __webpack_require__(/*! react */ 182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clone = __webpack_require__(/*! clone */ 198);
...
/***/ 255:
/*!***********************************************************************!*\
  !*** ./elements/bulbs-reading-list/lib/reading-list-event-manager.js ***!
  \***********************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _readingList = __webpack_require__(/*! ./reading-list */ 256);
	...
	var ReadingListEventManager = function () {
	  function ReadingListEventManager(element) {
	    _classCallCheck(this, ReadingListEventManager);
	
	    this.element = element;
	    var menu = element.getElementsByTagName('bulbs-reading-list-menu')[0];
	    var articles = element.getElementsByTagName('bulbs-reading-list-articles')[0];
	
	    this.scrollCalculationIsIdle = true;
	    this.readingList = new _readingList2.default(menu, articles);
	  }
	
	  ReadingListEventManager.prototype.handleMenuItemClick = function handleMenuItemClick(evnt) {
	    if (this.elementIsInsideMenu(evnt.target)) {
	      evnt.preventDefault();
	      var item = this.getClickedMenuItem(evnt.target);
	  ...
	  ReadingListEventManager.prototype.getClickedMenuItem = function getClickedMenuItem(element) {
	    var id = element.closest('bulbs-reading-list-item').dataset.id;
	    return this.readingList.getListItemById(id);
	  };
	
	  ReadingListEventManager.prototype.elementIsInsideMenu = function elementIsInsideMenu(element) {
	    (0, _invariant2.default)(element, 'BulbsReadingList.elementIsInsideMenu(element): element is undefined');
	    return !!element.closest('bulbs-reading-list-menu');
	  };
	
	  ReadingListEventManager.prototype.handleDocumentScrolled = function handleDocumentScrolled() {
	    if (!this.readingList.isFetchingNextItem) {
	      window.requestAnimationFrame(this.processScrollPosition.bind(this));
	    }
	  };
	
	  ReadingListEventManager.prototype.processScrollPosition = function processScrollPosition() {
	    if (this.readingList.hasMoreItems()) {
	      this.readingList.loadNextItem();
	    }
	  };
	
	  return ReadingListEventManager;
	}();
	
	exports.default = ReadingListEventManager;

/***/ },

/***/ 256:
/*!*********************************************************!*\
  !*** ./elements/bulbs-reading-list/lib/reading-list.js ***!
  \*********************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodash = __webpack_require__(/*! lodash */ 209);
	
	var _readingListItem = __webpack_require__(/*! reading-list-item */ 257);
	
	var _readingListItem2 = _interopRequireDefault(_readingListItem);
	...
	var ReadingList = function () {
	  function ReadingList(menu, articles) {
	    _classCallCheck(this, ReadingList);
	
	    (0, _invariant2.default)(menu, 'ReadingList(menu, articles): menu is undefined');
	    (0, _invariant2.default)(articles, 'ReadingList(menu, articles): articles is undefined');
	
	    var elementPairs = this.getReadingListElementPairs(menu, articles);
	    this.items = (0, _lodash.map)(elementPairs, this.createReadingListItem);
	    this.currentItem = this.firstItem();
	    this.isFetchingNextItem = false;
	  }
	
	  ReadingList.prototype.createReadingListItem = function createReadingListItem(elements, index) {
	    return new _readingListItem2.default(elements.menuItem, elements.article, index);
	  };
	
	  ReadingList.prototype.getReadingListElementPairs = function getReadingListElementPairs(menu, articles) {
	    return (0, _lodash.map)(menu.children, this.getArticleElementForMenuItemElement(articles.children));
	  };
	
	  ReadingList.prototype.findArticleElementForMenuItemElement = function findArticleElementForMenuItemElement(articles, menuItemElement) {
	    var articleElement = (0, _lodash.find)(articles, function (article) {
	      return article.dataset.id === menuItemElement.dataset.id;
	    });
	    (0, _invariant2.default)(articleElement, 'ReadingList.findArticleElementForMenuItemElement(articles, menuItem): menu item element with data-id="' + menuItemElement.dataset.id + '" has no corresponding article');
	    return articleElement;
	  };
	
	  ReadingList.prototype.getArticleElementForMenuItemElement = function getArticleElementForMenuItemElement(articles) {
	    return function (menuItemElement) {
	      var articleElement = this.findArticleElementForMenuItemElement(articles, menuItemElement);
	      return {
	  ...
	  ReadingList.prototype.firstItem = function firstItem() {
	    return (0, _lodash.minBy)(this.items, 'index');
	  };
	
	  ReadingList.prototype.lastItem = function lastItem() {
	    return (0, _lodash.maxBy)(this.items, 'index');
	  };
	
	  ReadingList.prototype.isFirstItem = function isFirstItem(item) {
	    return item === this.firstItem();
	  };
	
	  ReadingList.prototype.itemAtIndex = function itemAtIndex(index) {
	    (0, _invariant2.default)(!(0, _lodash.isUndefined)(index), 'ReadingList.itemAtIndex(index): index is undefined');
	    return (0, _lodash.find)(this.items, function (item) {
	      return item.index === index;
	    });
	  };
	
	  ReadingList.prototype.getListItemById = function getListItemById(id) {
	    (0, _invariant2.default)(id, 'ReadingList.getListItemById(id): id is undefined');
	    return (0, _lodash.find)(this.items, function (item) {
	      return item.id === id;
	    });
	  };
	
	  ReadingList.prototype.setCurrentItem = function setCurrentItem(item) {
	    (0, _invariant2.default)(item, 'ReadingList.setCurrentItem(item): item is undefined');
	    (0, _invariant2.default)((0, _lodash.includes)(this.items, item), 'ReadingList.setCurrentItem(item): item is not in reading list');
	  ...
	  ReadingList.prototype.isNextItem = function isNextItem(listItem) {
	    (0, _invariant2.default)(listItem, 'ReadingList.isNextItem(listItem): listItem is undefined');
	    var nextItem = this.itemAtIndex(this.currentItem.index + 1);
	    return nextItem ? listItem.index === nextItem.index : false;
	  };
	
	  ReadingList.prototype.isBeforeCurrentItem = function isBeforeCurrentItem(listItem) {
	    (0, _invariant2.default)(listItem, 'BulbsReadingList.isBeforeCurrentItem(listItem): listItem is undefined');
	    return listItem.index < this.currentItem.index;
	  };
	
	  ReadingList.prototype.nextItem = function nextItem() {
	    return this.itemAtIndex(this.currentItem.index + 1);
	  };
	
	  ReadingList.prototype.isAtTheEnd = function isAtTheEnd() {
	    return this.currentItem === this.lastItem();
	  };
	
	  ReadingList.prototype.isMoreThanOneAhead = function isMoreThanOneAhead(item) {
	    return item.index - this.currentItem.index > 1;
	  };
	
	  ReadingList.prototype.hasMoreItems = function hasMoreItems() {
	    return !this.isAtTheEnd();
	  };
	
	  ReadingList.prototype.hasPendingFetch = function hasPendingFetch() {
	    return (0, _lodash.some)(this.items, function (item) {
	      return item.fetchPending;
	    });
	  };
	
	  ReadingList.prototype.shouldLoadNextItem = function shouldLoadNextItem(nextItem) {
	    return !!(!this.hasPendingFetch() && nextItem && nextItem.isWithinViewThreshold(window.scrollY));
	  };
	
	  ReadingList.prototype.loadNextItem = function loadNextItem() {
	    var nextItem = this.nextItem();
	    if (this.shouldLoadNextItem(nextItem)) {
	      this.isFetchingNextItem = true;
	      nextItem.loadContent().then(this.handleLoadNextArticleComplete.bind(this));
	    } else {
	      this.isFetchingNextItem = false;
	    }
	  };
	
	  ReadingList.prototype.redirectToItem = function redirectToItem(item) {
	    window.location.href = item.href;
	  };
	
	  ReadingList.prototype.handleLoadNextArticleComplete = function handleLoadNextArticleComplete(article) {
	    this.isFetchingNextItem = false;
	    this.navigateToItem(article);
	  };
	
	  ReadingList.prototype.navigateToItem = function navigateToItem(item) {
...
/***/ 257:
/*!**************************************************************!*\
  !*** ./elements/bulbs-reading-list/lib/reading-list-item.js ***!
  \**************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _util = __webpack_require__(/*! bulbs-elements/util */ 190);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
	
	var ReadingListItem = function () {
	  function ReadingListItem(menuElement, articleElement, index) {
	    _classCallCheck(this, ReadingListItem);
	
	    (0, _invariant2.default)(menuElement, 'ReadingListItem(menuElement, articleElement, index): menuElement is undefined');
	    (0, _invariant2.default)(menuElement.dataset.id, 'ReadingListItem(menuElement, articleElement, index): menuElement has no data-id');
	    (0, _invariant2.default)(menuElement.dataset.href, 'ReadingListItem(menuElement, articleElement, index): menuElement has no data-href');
	    (0, _invariant2.default)(menuElement.dataset.title, 'ReadingListItem(menuElement, articleElement, index): menuElement has no data-title');
	    (0, _invariant2.default)(this.elementIsReadingListItem(menuElement), 'ReadingListItem(menuElement, articleElement, index): menuElement must be a bulbs-reading-list-item or have a reading-list-item class');
	    (0, _invariant2.default)(!(0, _lodash.isUndefined)(index), 'ReadingListItem(menuElement, articleElement, index): index is undefined');
	    (0, _invariant2.default)((0, _lodash.isNumber)(index), 'ReadingListItem(menuElement, articleElement, index): index is not a number');
	  ...
	  ReadingListItem.prototype.isLoaded = function isLoaded() {
	    return !!this.articleElement.children.length;
	  };
	
	  ReadingListItem.prototype.elementIsReadingListItem = function elementIsReadingListItem(element) {
	    (0, _invariant2.default)(element, 'ReadingListItem.elementIsReadingListItem(element): element is undefined');
	    var tagName = element.tagName.toLowerCase();
	    return tagName === 'bulbs-reading-list-item' || element.classList.contains('reading-list-item');
	  };
	
	  ReadingListItem.prototype.setAsCurrent = function setAsCurrent() {
	    this.menuElement.classList.add('current');
	    this.articleElement.classList.add('current');
	    this.isCurrent = true;
	  };
	
	  ReadingListItem.prototype.setAsNotCurrent = function setAsNotCurrent() {
	    this.menuElement.classList.remove('current');
	    this.articleElement.classList.remove('current');
	    this.isCurrent = false;
	  };
	
	  ReadingListItem.prototype.loadContent = function loadContent() {
	    if (this.shouldLoad()) {
	      this.fillContent(this.loadingTemplate);
	      return fetch(this.href).then(_util.filterBadResponse).then(_util.getResponseText).then(this.handleLoadContentComplete.bind(this)).catch(this.handleLoadContentError);
	    }
	
	    return new Promise(function (resolve, reject) {
	      return reject('Article should not load');
	    });
	  };
	
	  ReadingListItem.prototype.shouldLoad = function shouldLoad() {
	    return !(this.isLoaded() || this.fetchPending);
	  };
	
	  ReadingListItem.prototype.handleLoadContentComplete = function handleLoadContentComplete(content) {
	    var _this = this;
	  ...
	  ReadingListItem.prototype.handleLoadContentError = function handleLoadContentError(response) {
	    return new Promise(function (resolve, reject) {
	      return reject('ReadingListItem.loadContent(): fetch failed "' + response.status + ' ' + response.statusText + '"');
	    });
	  };
	
	  ReadingListItem.prototype.fillContent = function fillContent(content) {
	    this.articleElement.innerHTML = content;
	  };
	
	  ReadingListItem.prototype.isWithinViewThreshold = function isWithinViewThreshold() {
	    var scrollPosition = arguments.length <= 0 || arguments[0] === undefined ? 0 : arguments[0];
	
	    var difference = this.articleElement.offsetTop - scrollPosition;
	    return difference <= this.loadDistanceThreshold;
	  };
	
	  ReadingListItem.prototype.scrollIntoView = function scrollIntoView() {
	...
	exports.default = ReadingListItem;
